...
//     public float castWindup = 0.5f;
//     public float attackMoveSuppressionTime = 0.4f;
...
//     public float teleportGracePeriod = 0.5f;
    
//     [Header("Boss Phases")]
//     public float phase2HPThreshold = 0.6f; // 60% 이하
//     public float phase3HPThreshold = 0.3f; // 30% 이하
//     public float phase2WaveSpread = 40f;
//     public float phase3WaveSpread = 55f;
//     public float phase2WaveSpeedMultiplier = 1.1f;
//     public float phase3WaveSpeedMultiplier = 1.25f;

//     [Header("Phase 3 Special")]
//     public int radialBurstProjectiles = 10;
//     public float radialBurstDelay = 0.08f;
//     public float radialBurstSpeedMultiplier = 1.3f;
...
//         if (rb != null)
//         {
//             Vector2 targetVelocity = suppressMovement ? Vector2.zero : direction * moveSpeed;
//             rb.linearVelocity = Vector2.MoveTowards(
//                 rb.linearVelocity,
//                 targetVelocity,
//                 (suppressMovement ? deceleration : acceleration) * Time.deltaTime);
//         }
...
//         attackRoutine = StartCoroutine(CastEMWave());
//     }
