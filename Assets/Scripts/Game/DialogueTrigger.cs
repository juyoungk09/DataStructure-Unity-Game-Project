...
public class DialogueTrigger : MonoBehaviour
{
    ...
    public void StartPrologue()
    {
        ...
        MyDialogueLine[] dialogue = new MyDialogueLine[]
        {
            ...
            new MyDialogueLine { speakerName = "나레이션", portrait = null, sentence = "하지만 1학기 시작과 동시에 각 학년의 수행 일정이 발표되고, 교내 방송이 울린다." },
            new MyDialogueLine { speakerName = "교내 방송", portrait = null, sentence = "1학년 수행평가가 곧 시작됩니다.교실 지역 난이도: 하"},
    ...
    public void StartChapter1()
    {
        ...
        MyDialogueLine[] dialogue = new MyDialogueLine[]
        {
            new MyDialogueLine { speakerName = "나레이션", portrait = null, sentence = "✦ 챕터 1. 교실 — '기초 평가'\n복도는 학습체들이 가장 많이 출몰하는 기본 구역이다.\n수학 문제와 사회 개념이 엉켜 만들어진 약한 학습체들이 나타난다." },
            new MyDialogueLine { speakerName = "민기", portrait = npcMinGiImg, sentence = "처음엔 어색하지만, 곧 내가 배운 기본 동작을 익히며 작은 수행들을 완수해 나간다." },
            new MyDialogueLine { speakerName = "동아리 선배", portrait = npcGoAhYoonImg, sentence = "민기? 네 능력은 아직 안정되지 않았네.\n동아리 능력 중 하나를 선택해 전직해야 수행 난이도를 감당할 수 있어." },
            new MyDialogueLine { speakerName = "나레이션", portrait = null, sentence = "민기는 TAPIE(기사 타입) 또는 AnA(암살자 타입) 중 하나를 전직으로 선택한다." }
        };
    ...
    public void StartChapter2()
    {
        ...
        MyDialogueLine[] dialogue = new MyDialogueLine[]
        {
            new MyDialogueLine { speakerName = "지연 쌤", portrait = npcJiYeonImg, sentence = "회로가 틀리면? 당연히 폭발하지.\n그러니까 정확히 연결하고, 그 전에 이 학습체들부터 정리하고 오도록." },
